...
//        ChiSquareGOF.GetInstance(this.MaxNoPeakCluster);
    ...
    public void PeakClusterDetection(GridMassModel gridmass,float strt, float endrt) throws IOException, InterruptedException, ExecutionException {
...
//        CreatePeakFolder();
        ...
        detection.DetectPeakClusters(scanCollections,gridmass,strt,endrt);
