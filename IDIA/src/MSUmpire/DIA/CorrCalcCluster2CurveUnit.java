...
//                    corr = PeakCurveCorrCalc.CalPeakCorrOrg(targetMS1Curve, peakCurve, parameter.NoPeakPerMin);
                ...
                if (!Float.isNaN(corr) && corr > parameter.CorrThreshold) {
                    ...
                    PrecursorFragmentPair.Amz = (float) (MS1PeakCluster.MonoIsotopePeak.TargetMz*MS1PeakCluster.Charge-ElementaryIon.proton.getTheoreticMass()*MS1PeakCluster.Charge);
                    ...
                    PrecursorFragmentPair.corrInty = corr*corr*(float) Math.log(peakCurve.ApexInt);
