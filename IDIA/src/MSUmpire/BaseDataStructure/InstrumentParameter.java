...
//    public boolean Deisotoping = false;
    ...
    public transient double intensitySimilarity = 0.5f;
    public transient double minimumTimeSpan, maximumTimeSpan ;
    public transient double smoothTimeSpan , smoothTimeMZ , smoothMZ ;//2*this.smoothTimeSpan
    public transient double mzTol;
    public transient double minimumHeight = 10;
    public transient double similarityTwoMethods;
