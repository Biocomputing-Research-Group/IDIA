...
//    }
    ...
    public void DetectPeakCurves(ScanCollection scanCollection, GridMassModel gridmass, float scanstrt, float scanendrt) throws FileNotFoundException, IOException {        
        
        LCMSPeakBase.UnSortedPeakCurves = new ArrayList<>();
        FindAllMzTracePeakCurves(scanCollection,gridmass, scanstrt, scanendrt,"ms2");
        gridmass=null;
...
//        ((LCMSPeakDIAMS2) LCMSPeakBase).FilterByCriteriaUnfrag(LCMSPeakBase.PeakClusters);
...
//        ArrayList<CorrCalcCluster2CurveUnit> PrecursorPairList = new ArrayList<>();
        ...
        ((LCMSPeakDIAMS2) LCMSPeakBase).BuildFragmentMS1ranking(String.valueOf(DIAWindowMz.getX())+"_"+String.valueOf(DIAWindowMz.getY()));
        int[] tmp=((LCMSPeakDIAMS2) LCMSPeakBase).FilterByCriteria(String.valueOf(DIAWindowMz.getX())+"_"+String.valueOf(DIAWindowMz.getY()),ms1lcms.PeakClusters);
//        ((LCMSPeakDIAMS2) LCMSPeakBase).ExportCluster2CurveCorr();
