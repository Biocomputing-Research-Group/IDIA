...
public class PDHandlerMS1 extends PDHandlerBase {
    ...
    public void DetectPeakClusters(ArrayList<ScanCollection> scanCollections,GridMassModel gridmass, float strt, float endrt) throws InterruptedException, ExecutionException, IOException {        
        FindAllMzTracePeakCurvesForScanCollections(scanCollections, gridmass,strt, endrt,"ms1");
